      ...
      <DialogContent>
        <form id="tracker-form" onSubmit={formik.handleSubmit}>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 2 }}>
            ...
            {!editMode && (
              <ShareEmailsField
                emails={formik.values.shareEmails || []}
...
const TrackerTypeSelector: React.FC<TrackerTypeSelectorProps> = ({
  ...
  <Box>
    <Typography
      variant="subtitle2"
      sx={{ mb: 1.5, color: theme.palette.text.secondary, fontWeight: 600, fontSize: '0.875rem' }}
    >
      Tracker Type *
    </Typography>
        ...
        return (
          <Box
            ...
            sx={{
              ...
              '&:hover': disabled
                ? {}
                : { borderColor: cfg.primary, bgcolor: cfg.bg, transform: 'translateY(-2px)' },
            }}
          >
            <Box
              sx={{
                ...
                background: active ? cfg.gradient : theme.palette.action.hover,
              }}
            >
            ...
            <Typography
              ...
              sx={{
                color: active ? cfg.primary : theme.palette.text.primary,
...
const ShareEmailsField: React.FC<ShareEmailsFieldProps> = ({
  emails,
  onChange,
  error,
  disabled,
