...
const PaymentMethodDetailsDialog: React.FC<PaymentMethodDetailsDialogProps> = ({
  open, onClose, data, currency,
}) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth
      ...
      <DialogTitle sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', pb: 1 }}>
        <Typography variant="h6" fontWeight={600}>Payment Method Details</Typography>
